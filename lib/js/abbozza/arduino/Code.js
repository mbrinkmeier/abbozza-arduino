...
AbbozzaCode['text_to_number'] = ["(#).toInt()" , ["V_TEXT"] ];
AbbozzaCode['text_to_decimal'] = ["(#).toFloat()" , ["V_TEXT"] ];
...
AbbozzaCode['serial_write_byte'] = [ "writeByteToUSB(#);" , [ "V_VALUE" ] ];
AbbozzaCode['serial_write_int'] = [ "writeIntToUSB(#);" , [ "V_VALUE" ] ];
AbbozzaCode['serial_read_byte'] = [ "readByteFromUSB()" , [] ];
AbbozzaCode['serial_read_int'] = [ "readIntFromUSB()" , [] ];
...
AbbozzaCode['message_word'] = [ "__serial_parser.parse_word()" , [] , function (generator) { generator.serialParserRequired = true; }];
AbbozzaCode['message_string'] = [ "__serial_parser.parse_string()" , [] , function (generator) { generator.serialParserRequired = true; }];
AbbozzaCode['message_response'] = ["__serial_parser.sendResponse(#);" , [
   function(generator) {
            var content = this.getFieldValue("MSG");
            return goog.string.quote(content);            
        }
] , function (generator) { generator.serialParserRequired = true; } ];
