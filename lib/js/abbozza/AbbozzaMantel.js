...
Abbozza.init = function (systemPrefix, devAllow, helpUrl) {
    ...
    // Set zoom to 125%
    var body = document.getElementsByTagName("BODY")[0].style.zoom="125%";
    ...
    TaskWindow.resizable = false;
    TaskWindow.editable = false;
    TaskWindow.closable = false;
...
Abbozza.goHome= function() {
    var homeUrl = Configuration.getParameter("homeUrl");
    
    if ( !homeUrl ) {
        homeUrl = "";
    }
    
    console.log("Going home : " + homeUrl);
